...
class Job {
  ...
  static async findAll({ minSalary, hasEquity, title } = {}) {
    let query = `SELECT j.id, j.title, j.salary, j.equity, j.company_handle AS "companyHandle", c.name AS "companyName" FROM jobs j 
  ...
  static async update(id, data) {
    ...
    const querySql = `UPDATE jobs SET ${setCols} RETURNING id, title, salary, equity, company_handle AS "companyHandle"`;
